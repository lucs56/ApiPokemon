...
function App() {
  // Escribe aquí la URL de la imagen de fondo, o deja el string vacío para no tener fondo:
  const backgroundUrl = "https://wallpapers.com/images/featured/pokemon-hd-fazqcs1tmwwte1ap.jpg"; // Ejemplo: "https://tusitio.com/tuimagen.jpg"
  ...
  const fetchPokemons = async () => {
    ...
    try {
      ...
      // Volver a obtener los detalles de cada Pokémon (esto es lo que permite mostrar las tarjetas completas)
